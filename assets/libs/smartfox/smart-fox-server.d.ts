declare namespace SFS2X {
    ...
    namespace Entities {
        ...
        namespace Match {
            ...
            export class MatchExpression {
                ...
                condition: RoomProperties | UserProperties | BoolMatch | NumberMatch | StringMatch | Requests.Game.CreateSFSGameRequest | FindRoomsRequest | FindUsersRequest;
                loginOp: LogicOperator;
                next: MatchExpression;
                value: any;
                varName: string;

                constructor(varName: string, condition: RoomProperties | UserProperties | BoolMatch | NumberMatch | StringMatch | Requests.Game.CreateSFSGameRequest | FindRoomsRequest | FindUsersRequest, value: any);
                and(varName: string, condition: RoomProperties | UserProperties | BoolMatch | NumberMatch | StringMatch | Requests.Game.CreateSFSGameRequest | FindRoomsRequest | FindUsersRequest, value: any): MatchExpression;
                hasNext(): boolean;
                or(varName: string, condition: RoomProperties | UserProperties | BoolMatch | NumberMatch | StringMatch | Requests.Game.CreateSFSGameRequest | FindRoomsRequest | FindUsersRequest, value: any): MatchExpression;
            ...
            export class RoomProperties {
                ...
                static GROUP_ID;
                static HAS_FREE_PLAYER_SLOTS;
                static IS_GAME;
                static IS_PRIVATE;
                static IS_TYPE_SFSGAME;
                static MAX_SPECTATORS;
                static MAX_USERS;
                static NAME;
                static SPECTATOR_COUNT;
                static USER_COUNT;
    ...
    export interface IBUDDY_ADD {
        buddy: Entities.SFSBuddy;
    }

    export interface IBUDDY_BLOCK {
        buddy: Entities.SFSBuddy;
    }

    export interface IBUDDY_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IBUDDY_LIST_INIT {
        buddyList: Entities.SFSBuddy[];
        myVariables: Entities.Variables.SFSBuddyVariable[];
    }

    export interface IBUDDY_MESSAGE {
        buddy: Entities.SFSBuddy;
        isItMe: boolean;
        message: string;
        data: Object;
    ...
    export interface IBUDDY_ONLINE_STATE_CHANGE {
        buddy: Entities.SFSBuddy;
        isItMe: boolean;
    }

    export interface IBUDDY_REMOVE {
        buddy: Entities.SFSBuddy;
    }

    export interface IBUDDY_VARIABLES_UPDATE {
        buddy: Entities.SFSBuddy;
        isItMe: boolean;
        changedVars: string[];
    }
    ...
    export interface IADMIN_MESSAGE {
    ...
    export interface ICONNECTION_LOST {
        reason: string;
    }

    export interface IEXTENSION_RESPONSE {
        cmd: string;
        params: Object;
        sourceRoom: number;
    }
    ...
    export interface IINVITATION_REPLY {
        invitee: Entities.SFSUser;
        reply: number;
        data: Object;
    }

    export interface IINVITATION_REPLY_ERROR {
        errorMessage: string;
        errorCode: number;
    }
    ...
    export interface IMMOITEM_VARIABLES_UPDATE {
        room: Entities.MMORoom;
        mmoItem: Entities.MMOItem;
        changedVars: string[];
    }

    export interface IMODERATOR_MESSAGE {
        sender: Entities.SFSUser;
        message: string;
        data: Object;
    }

    export interface IOBJECT_MESSAGE {
        sender: Entities.SFSUser;
        message: string;
    }

    export interface IPING_PONG {
        lagValue: number;
    }

    export interface IPLAYER_TO_SPECTATOR {
        room: Entities.SFSRoom;
        user: Entities.SFSUser;
    }

    export interface IPLAYER_TO_SPECTATOR_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IPRIVATE_MESSAGE {
        sender: Entities.SFSUser;
        message: string;
        data: Object;
    }

    export interface IPROXIMITY_LIST_UPDATE {
    ...
    export interface IPUBLIC_MESSAGE {
        room: Entities.SFSRoom;
        sender: Entities.SFSUser;
        message: string;
        data: Object;
    ...
    export interface IROOM_ADD {
        room: Entities.SFSRoom;
    }

    export interface IROOM_CAPACITY_CHANGE {
        room: Entities.SFSRoom;
    }

    export interface IROOM_CAPACITY_CHANGE_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IROOM_CREATION_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IROOM_FIND_RESULT {
        rooms: Entities.SFSRoom[];
    }

    export interface IROOM_GROUP_SUBSCRIBE {
        groupId: string;
        newRooms: Entities.SFSRoom[];
    }

    export interface IROOM_GROUP_SUBSCRIBE_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IROOM_GROUP_UNSUBSCRIBE {
        groupId: string;
    }

    export interface IROOM_GROUP_UNSUBSCRIBE_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IROOM_JOIN {
        room: Entities.SFSRoom;
    }

    export interface IROOM_JOIN_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IROOM_NAME_CHANGE {
        room: Entities.SFSRoom;
        oldName: string;
    }

    export interface IROOM_NAME_CHANGE_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IROOM_PASSWORD_STATE_CHANGE {
        room: Entities.SFSRoom;
    }

    export interface IROOM_PASSWORD_STATE_CHANGE_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IROOM_REMOVE {
        room: Entities.SFSRoom;
    }

    export interface IROOM_VARIABLES_UPDATE {
        room: Entities.SFSRoom;
        changedVars: string[];
    }

    export interface ISOCKET_ERROR {
        errorMessage: string;
    }

    export interface ISPECTATOR_TO_PLAYER {
        room: Entities.SFSRoom;
        user: Entities.SFSUser;
        playerId: number;
    }

    export interface ISPECTATOR_TO_PLAYER_ERROR {
        errorMessage: string;
        errorCode: number;
    }

    export interface IUSER_COUNT_CHANGE {
        room: Entities.SFSRoom;
        uCount: number;
        sCount: number;
    }

    export interface IUSER_ENTER_ROOM {
        user: Entities.SFSUser;
        room: Entities.SFSRoom;
    }

    export interface IUSER_EXIT_ROOM {
        user: Entities.SFSUser;
        room: Entities.SFSRoom;
    }

    export interface IUSER_FIND_RESULT {
        users: Entities.SFSUser[];
    }

    export interface IUSER_VARIABLES_UPDATE {
        user: Entities.SFSUser;
        changedVars: string[];
    }
    //#endregion
