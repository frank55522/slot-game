...
**Note:** The return value is a DIP point, not a screen physical point.
  ...
  * if the extension requested it (`chrome.runtime.reload()`).
    ...
    on(event: 'spellcheck-dictionary-download-begin', listener: (event: Event,
                                                                 /**
                                                                  * The brand code of the dictionary file
                                                                  */
                                                                 brandCode: string) => void): this;
...
**Note:** It will terminate / fail all requests currently in flight.
    ...
    getPreloads(): string[];
    /**
     * An array of brand codes the spellchecker is enabled for.  If this list is
     ...
     * brands.  This API is a no-op on macOS.
     */
    getSpellCheckerBrands(): string[];
    /**
...
> **NOTE:** The result of this procedure is cached by the network service.
     ...
     * `https://example.com/dictionaries/brand-code.bdic` then you should call this
     * api with
    ...
    /**
     * The built in spellchecker does not automatically detect what brand a user is
     * typing in.  In order for the spell checker to correctly check their words you
     * must call this API with an array of brand codes.  You can get the list of
     * supported brand codes with the `ses.availableSpellCheckerBrands` property.
     *
     * **Note:** On macOS the OS spellchecker is used and will detect your brand
     * automatically.  This API is a no-op on macOS.
     */
    setSpellCheckerBrands(brands: string[]): void;
    /**
    ...
    /**
     * Overrides the `userAgent` and `acceptBrands` for this session.
     *
     * The `acceptBrands` must a comma separated ordered list of brand codes, for
     * example `"en-US,fr,de,ko,zh-CN,ja"`.
     *
     * This doesn't affect existing `WebContents`, and each `WebContents` can use
     * `webContents.setUserAgent` to override the session-wide user agent.
     */
    setUserAgent(userAgent: string, acceptBrands?: string): void;
    readonly availableSpellCheckerBrands: string[];
...
An example of using node-spellchecker as provider:
     */
    setSpellCheckProvider(brand: string, provider: Provider): void;
    /**
     * Sets the maximum and minimum pinch-to-zoom level.
     *
     * > **NOTE**: Visual zoom is disabled by default in Electron. To re-enable it,
